...
const ESCENA_NUBE_FISICA = preload("res://scenes/entorno/cielo/nube_estilizada_3d.tscn")
const ESCENA_NUBE_ESPIRITUAL = preload("res://scenes/entorno/cielo/nube_estilizada_espiritual_3d.tscn")
